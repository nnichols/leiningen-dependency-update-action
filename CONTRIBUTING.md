...
1. Update the [CHANGELOG.md](https://github.com/nnichols/leiningen-dependency-update-action/blob/master/CHANGELOG.md) with details of all changes.
2. If any changes impact the external interface or use of **nnichols**, please update the [README](https://github.com/nnichols/leiningen-dependency-update-action/blob/master/README.md) to reflect any relevant differences.
...
If you're looking to pitch in more extensively, check out the open [issues and feature requests](https://github.com/nnichols/leiningen-dependency-update-action/issues) and take a crack at one of them.
...
A full copy of our [code of conduct may be found here.](https://github.com/nnichols/leiningen-dependency-update-action/blob/master/CODE_OF_CONDUCT.md)
